...
const ALLOWED_KEYS = new Set([
  ...
  "veritas_sl_mult", "veritas_tp_mult", "legacy_atr_multipliers_enabled", "legacy_sl_mult", "legacy_tp_mult", "veritas_min_hurst",
...
function sanitize(patch: Record<string, unknown>): Record<string, unknown> {
  const numericFields = [
    ...
    "scan_interval_minutes","veritas_sl_mult","veritas_tp_mult","legacy_atr_multipliers_enabled","legacy_sl_mult","legacy_tp_mult","veritas_min_hurst",
